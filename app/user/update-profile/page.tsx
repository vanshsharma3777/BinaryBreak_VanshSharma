        ...
        >
          ...
          <div className="bg-zinc-950/60 backdrop-blur-2xl border border-zinc-800 rounded-[2rem] p-8 md:p-12 shadow-2xl">
            <header className="mb-10">
              ...
              <p className="text-zinc-500 text-sm font-medium">Refine your details to keep your account current.</p>
            </header>
            ...
            <form onSubmit={handleSubmit} className="space-y-7">
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-[0.15em] text-zinc-600 ml-1">Current Address</label>
                <div className="relative group">
